...
export function PhotoAlbumsPageClient({ fotosPageData, photoAlbums }: PhotoAlbumsPageClientProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <PageBanner
        banner={fotosPageData?.banner}
        title={fotosPageData?.title || 'Fotoalbums'}
        subtitle={fotosPageData?.subtitle || 'Herbeleef onze avonturen! Bekijk foto\'s van kampen, weekends en activiteiten.'}
