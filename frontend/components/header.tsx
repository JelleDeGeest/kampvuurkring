...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
      <div className="container px-4 lg:px-12 flex h-14 items-center">
        {/* Desktop Navigation */}
        <div className="mr-4 hidden md:flex">
          <TransitionLink href="/" className="mr-6 flex items-center space-x-2 hover:opacity-80 transition-opacity" onClick={handleLogoClick}>
            <span className="hidden font-heading font-bold text-primary text-lg sm:inline-block">Scouts Sint-Johannes</span>
          </TransitionLink>
        ...
        <div className="flex md:hidden w-full items-center justify-between">
          ...
          {/* Centered Logo */}
          <TransitionLink href="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity" onClick={handleLogoClick}>
            <span className="font-heading font-bold text-primary text-lg">Scouts Sint-Johannes</span>
          </TransitionLink>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 right-0 bg-background/95 backdrop-blur border-t shadow-lg overflow-hidden"
          >
