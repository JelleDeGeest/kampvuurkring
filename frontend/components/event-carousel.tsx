    ...
    <div className="relative w-full h-[300px] md:h-[367px] lg:h-[400px] rounded-2xl overflow-hidden group">
      ...
      <div className="h-full w-full relative">
        {heroes.map((hero, index) => {
          // Calculate z-index to ensure the active hero is always on top
          // and newer heroes appear above older ones during transitions
          ...
          return (
            ...
            >
              ...
              {hasCompleteInfo(hero) && (
                <div className="absolute top-1/2 right-4 md:right-8 lg:right-16 transform -translate-y-1/2">
